...
t0 = Label(tk, text="User", font=("Times New Roman", 16))
t0.place(x=size_canvas_x // 2 - t0.winfo_reqwidth() // 2, y=size_canvas_y + 3)
t1 = Label(tk, text="AI", font=("Times New Roman", 16))
...
b0 = Button(tk, text="Показать корабли User", command=button_show_enemy1)
b0.place(x=size_canvas_x + 20, y=30)

b1 = Button(tk, text="Показать корабли AI", command=button_show_enemy2)
